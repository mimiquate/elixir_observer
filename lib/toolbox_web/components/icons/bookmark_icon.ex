defmodule ToolboxWeb.Components.Icons.BookmarkIcon do
  ...
  def bookmark_icon(assigns) do
    ~H"""
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class={"#{@class}"}>
      <mask
        id="mask0_2433_71528"
